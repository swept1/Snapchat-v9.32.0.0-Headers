...
- (void)verifyCaptcha:(_Bool)arg1 usernameOrEmail:(id)arg2;
- (void)verifyCaptcha;
- (void)loadCaptchaImages:(_Bool)arg1 usernameOrEmail:(id)arg2;
- (void)loadCaptcha:(_Bool)arg1 usernameOrEmail:(id)arg2;
- (void)loadCaptcha;
- (void)dealloc;
