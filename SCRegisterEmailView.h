...
@interface SCRegisterEmailView : UIView <SCTextViewDelegate, UIScrollViewDelegate, SCRegisterViewProtocol>
{
    id <SCRegisterEmailViewDelegate> _delegate;
    NSString *_email;
...
@property(nonatomic) __weak id <SCRegisterEmailViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
