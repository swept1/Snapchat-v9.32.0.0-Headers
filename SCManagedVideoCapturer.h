...
@class AVAssetWriter, AVAssetWriterInput, FBKVOController, NSDictionary, NSError, NSString, NSURL, SCAudioCaptureSession, SCQueuePerformer;

@interface SCManagedVideoCapturer : NSObject <SCAudioCaptureSessionDelegate, SCManagedVideoDataSourceListener>
{
...
- (void)startRecordingAsynchronouslyWithOutputSettings:(id)arg1 toURL:(id)arg2 deviceFormat:(id)arg3 orientation:(long long)arg4;
