...
@class EphemeralMedia, NSData, NSIndexPath, NSString, NSTimer, SCBaseUploadableChatMedia, SCBorderOverlayView, SCCaptionManager, SCCaptionModeButton, SCChatMediaMessage, SCColorPicker, SCCustomVolumeController, SCDetectTouchView, SCDiscoverMediaMessage, SCDrawingButton, SCDrawingView, SCGeoFilterLogger, SCGradientView, SCGrowingButton, SCLocationController, SCPreviewActivityViewController, SCPreviewConfiguration, SCPreviewDependencyLoadingStates, SCPreviewLogger, SCPreviewSnapSender, SCPreviewSnapchatGallerySnapEditingStates, SCPreviewTooltipBalloon, SCSelectRecipientsView, SCSendConfirmationView, SCSimultaneousLoadingView, SCSnapCommonLoggingParameters, SCStickerContainer, SCStickerPickerButton, SCStickerPickerMenuView, SCSwipeFilterView, SendViewController, SnapVideoFilter, TimerButton, UIImageView, UILabel, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer, UIView;

@interface PreviewViewController : UIViewController <UIGestureRecognizerDelegate, SCColorPickerDelegate, SCDrawingDelegate, SCCaptionManagerDelegate, SCStickerPickerMenuDelegate, SCSwipeFilterViewDelegate, SCPromptFilterViewDelegate, SCSelectGroupRecipientsDelegate, TimerButtonDelegate, SCSendConfirmationViewControllerDelegate, SCSendViewControllerSendingDelegate, SCPreviewFilterDataProviderDelegate, SCTimeProfilable, SCPreviewDependencyLoadingStatesDelegate, SCDetectTouchViewDelegate, SCPreviewActivityItemProviderDelegate, UIActionSheetDelegate, SCStartChatDelegate>
{
    ...
    SCPreviewTooltipBalloon *_newStickerTooltipBalloon;
...
@property(retain, nonatomic) NSIndexPath *stickerIndexPath; // @synthesize stickerIndexPath=_stickerIndexPath;
...
@property(retain, nonatomic) SCGrowingButton *sendButton; // @synthesize sendButton=_sendButton;
...
- (void).cxx_destruct;
- (void)sendViewController:(id)arg1 sendToRecipients:(id)arg2 invitedRecipients:(id)arg3 postToMyStory:(_Bool)arg4 officialStories:(id)arg5 sharedStories:(id)arg6 gallery:(_Bool)arg7;
- (void)_didScreenShot;
...
- (id)filtersStateWithStripsUnselectedSponsoredFilters:(_Bool)arg1;
...
- (id)_idSpecificFilterNameWithFilterName:(id)arg1 filterId:(id)arg2;
- (void)_addMotionFiltersToSwipeFilterView:(id)arg1;
- (void)_addVisualFiltersToSwipeFilterView:(id)arg1;
- (void)_addSmartFiltersToSwipeFilterView:(id)arg1;
...
- (void)pinch:(id)arg1;
- (void)pan:(id)arg1;
- (void)_disableStickerTracking:(id)arg1;
- (void)_enableStickerTracking:(id)arg1;
- (void)_prepareStickerTracking:(id)arg1;
- (void)tap:(id)arg1;
...
- (void)closedStickerPickerMenuAtCategory:(id)arg1 sticker:(id)arg2;
...
- (void)_saveAssetChangesAsNewCopy:(_Bool)arg1;
- (void)_deleteAsset;
...
- (void)_setupVideoFilterViewWithOverlayViews;
- (void)_setupImageFilterViewWithDrawingView;
...
- (void)prepareMediaVideo:(id)arg1 chatMediaVideo:(id)arg2 overlayImage:(id)arg3 overlayImageForMask:(id)arg4 thumbnailImage:(id)arg5 videoTrackedImages:(id)arg6;
- (void)prepareMediaImage:(id)arg1 chatMediaImage:(id)arg2 withScreenshot:(id)arg3;
...
- (void)postDirectlyToMyStory:(_Bool)arg1 withOfficialStories:(id)arg2 withSharedStories:(id)arg3;
...
- (void)_trashPressed;
- (void)_savePressed;
- (void)_saveToSnapchatGalleryAutosaved:(_Bool)arg1 showsSavingIndicator:(_Bool)arg2;
