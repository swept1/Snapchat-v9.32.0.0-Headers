...
@class NSArray, NSDictionary, NSNumber, NSString, SOJUBroadcastStoriesOrderingOrderingResponse, SOJUServerInfoResponse;
...
- (id)initWithMyStories:(id)arg1 myStoriesWithCollabs:(id)arg2 friendStories:(id)arg3 deletedFriendStories:(id)arg4 myGroupStories:(id)arg5 myVerifiedStories:(id)arg6 matureContentText:(id)arg7 friendStoriesDelta:(id)arg8 orderingResponse:(id)arg9 serverInfo:(id)arg10;
