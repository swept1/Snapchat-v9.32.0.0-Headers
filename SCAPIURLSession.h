...
@interface SCAPIURLSession : NSObject <SCAPIURLSessionActivityTrackerDelegate, SCStudySettingsListener, NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
{
    ...
    _Bool _shouldUseAdaptiveTimeoutForUploadSession;
    NSString *_sessionToGetServerLatencyForUploadSession;
    double _minTimeoutIntervalForUploadSession;
...
- (double)adaptiveTimeoutIntervalForUploadSession;
