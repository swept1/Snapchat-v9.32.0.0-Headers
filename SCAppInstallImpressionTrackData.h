...
@interface SCAppInstallImpressionTrackData : NSObject <SCSnapAdsSerializableData, NSCopying>
{
...
- (id)serialize;
- (id)initWithTopsnapTimeViewedSeconds:(id)arg1 topsnapMediaDurationSeconds:(id)arg2 swiped:(id)arg3;
