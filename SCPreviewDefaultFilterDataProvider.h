...
@class NSArray, NSDate, NSDictionary, NSMutableDictionary, NSString, SCGeoFilterImagesFetcher, SCLocationServicesDataStore, SCSpeed, SCTimestampMetadata, SCUnlockableDataStore, SCWeather;
...
- (void)_unlockedFilterDataDidUpdate:(id)arg1;
