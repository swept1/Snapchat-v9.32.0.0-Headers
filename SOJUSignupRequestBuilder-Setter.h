...
#import "SOJUSignupRequestBuilder.h"

@interface SOJUSignupRequestBuilder (Setter)
- (id)setReactivationConfirmedValue:(_Bool)arg1;
...
- (id)setFromDeeplinkValue:(_Bool)arg1;
- (id)setRememberDeviceValue:(_Bool)arg1;
@end
