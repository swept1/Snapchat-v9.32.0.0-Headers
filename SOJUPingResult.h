...
@interface SOJUPingResult : NSObject <SOJUPingResult>
{
    ...
    NSNumber *_pingStartTime;
}

@property(readonly, copy, nonatomic) NSNumber *pingStartTime; // @synthesize pingStartTime=_pingStartTime;
...
- (id)initWithPingTotalLatency:(id)arg1 pingFirstBytesLatency:(id)arg2 pingResponseSize:(id)arg3 pingStartTime:(id)arg4;
