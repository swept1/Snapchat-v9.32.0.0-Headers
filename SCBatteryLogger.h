...
@class NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, SCBatteryHistory, SCBatteryLoggerTimerItem;
...
- (void)addBlizzardEvent:(id)arg1;
- (void)addPerformanceEvent:(id)arg1;
- (void)pageViewSessionDidEnd:(id)arg1;
- (void)pageViewSessionDidStart:(id)arg1;
