...
- (void)dealloc;
- (id)initWithInputPixelBuffer:(struct __CVBuffer *)arg1 outputPixelBuffer:(struct __CVBuffer *)arg2 orientation:(long long)arg3 presentationTime:(CDStruct_1b6d18a9)arg4 GPUCommands:(id)arg5 CPUCommands:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
