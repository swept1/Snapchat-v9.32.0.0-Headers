...
@class NSString, SCSwipeFilterView, UILongPressGestureRecognizer;
...
- (void)swipeFilterView:(SCSwipeFilterView *)arg1 longPressDidCancel:(UILongPressGestureRecognizer *)arg2;
