...
#import "SOJUDiscoverDiscoverUserViewHistoryRequest.h"

@class NSArray, NSString;

@interface SOJUDiscoverDiscoverUserViewHistoryRequest : NSObject <SOJUDiscoverDiscoverUserViewHistoryRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 channels:(id)arg4;
