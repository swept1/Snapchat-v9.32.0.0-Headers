...
@class SCStoryMediaCardViewModel;

@interface SCStoryMediaChatViewModel : SCSavableItemChatViewModel
{
    SCStoryMediaCardViewModel *_storyMediaCardViewModel;
}

@property(readonly, nonatomic) SCStoryMediaCardViewModel *storyMediaCardViewModel; // @synthesize storyMediaCardViewModel=_storyMediaCardViewModel;
- (void).cxx_destruct;
