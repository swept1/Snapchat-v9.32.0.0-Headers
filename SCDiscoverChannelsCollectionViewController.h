...
@interface SCDiscoverChannelsCollectionViewController : UICollectionViewController <SCTimeProfilable, SCDiscoverChannelsStoriesOrganizerDelegate, SCHorizontalScrollSection, Subview, UICollectionViewDelegateFlowLayout>
{
    ...
    _Bool _hasDoneStartupPerfMeasurement;
...
@property(nonatomic) _Bool hasDoneStartupPerfMeasurement; // @synthesize hasDoneStartupPerfMeasurement=_hasDoneStartupPerfMeasurement;
...
- (void)_collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2 showInitialLoadingView:(_Bool)arg3;
...
- (void)selectChannelAtIndex:(unsigned long long)arg1 showInitialLoadingView:(_Bool)arg2;
...
- (void)observeTiles:(id)arg1;
- (void)_handleLongPress:(id)arg1;
- (void)_setupGestureRecognizers;
- (void)didAppStartupComplete;
- (void)dealloc;
- (id)initWithCollectionViewLayout:(id)arg1 discoverChannels:(id)arg2 tiles:(id)arg3 channelViewContext:(unsigned long long)arg4;
