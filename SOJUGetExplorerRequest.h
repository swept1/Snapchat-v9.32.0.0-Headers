...
#import "SOJUGetExplorerRequest.h"

@class NSArray, NSString;

@interface SOJUGetExplorerRequest : NSObject <SOJUGetExplorerRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
@property(readonly, copy, nonatomic) NSString *shared; // @synthesize shared=_shared;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 shared:(id)arg4 snaps:(id)arg5 experimentId:(id)arg6;
