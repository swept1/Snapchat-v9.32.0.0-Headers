...
- (void)dealloc;
- (id)initWithImageProcessQueue:(id)arg1 GPUCommands:(id)arg2 CPUCommands:(id)arg3 assetReader:(id)arg4 assetWriter:(id)arg5 readerOutput:(id)arg6 writerInput:(id)arg7 pixelBufferAdaptor:(id)arg8 orientation:(long long)arg9 queue:(id)arg10 firstSampleBuffer:(struct opaqueCMSampleBuffer *)arg11 maxFrameRate:(int)arg12 presentationTimeScale:(double)arg13;
