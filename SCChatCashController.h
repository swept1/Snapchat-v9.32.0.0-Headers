...
@class NSString, SCBlockerResolutionInstance, SCCashLongPressGestureRecognizer, SCChat, SCChatViewModelForChat, SCPaymentSwipeReceiverViewController, SCPaymentSwipeSenderViewController, SCPotentiallyEligibleCashUserFlow, UIView, UIViewController;

@interface SCChatCashController : NSObject <SCBlockerResolutionResultDelegate, SCPasscodeForConfirmBlockerDelegate, SCPaymentSwipeSenderDelegate, SCPaymentSwipeReceiverDelegate, SCPotentiallyEligibleFlowDelegate, SCCardLinkingDelegate, UIGestureRecognizerDelegate, SCChatViewLifeCycleListener>
{
