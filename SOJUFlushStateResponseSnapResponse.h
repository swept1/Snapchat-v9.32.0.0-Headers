...
@interface SOJUFlushStateResponseSnapResponse : NSObject <SOJUFlushStateResponseSnapResponse>
{
    NSArray *_esIds;
    NSNumber *_logged;
    NSNumber *_throttled;
...
- (id)initWithEsIds:(id)arg1 logged:(id)arg2 throttled:(id)arg3 success:(id)arg4;
