...
#import "SCInAppBrowserDelegate.h"
#import "SCSafeBrowsingWarningViewDelegate.h"
#import "UIActionSheetDelegate.h"
#import "UIScrollViewDelegate.h"

@class NSMutableArray, NSMutableDictionary, NSString, NSTimer, NSURL, NSURLRequest, SCBrowserLocationBarView, SCInAppBrowser, UIButton, UIView;

@interface SCBrowserViewController : SCDownSwipableViewController <SCInAppBrowserDelegate, UIScrollViewDelegate, UIActionSheetDelegate, SCSafeBrowsingWarningViewDelegate>
{
    _Bool _navButtonsEnabled;
    _Bool _safebrowsingEnabled;
    _Bool _forceUIWebView;
    _Bool _safeBrowsingisLoadingLearnMoreUrl;
    SCInAppBrowser *_webView;
    id <SCBrowserViewControllerDelegate> _delegate;
    UIView *_safeBrowsingWarningView;
...
+ (_Bool)_patternIsMatch:(id)arg1 forUrlString:(id)arg2;
+ (_Bool)_isiTunesURL:(id)arg1;
...
@property(retain, nonatomic) UIView *safeBrowsingWarningView; // @synthesize safeBrowsingWarningView=_safeBrowsingWarningView;
...
@property(retain, nonatomic) SCInAppBrowser *webView; // @synthesize webView=_webView;
- (void).cxx_destruct;
