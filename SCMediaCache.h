...
@interface SCMediaCache : NSCache <NSCacheDelegate>
{
    ...
    NSObject<OS_dispatch_queue> *_resetMediaStateQueue;
}

+ (id)anyWriteFileQueue;
+ (id)anyCacheQueue;
+ (id)sharedCache;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *resetMediaStateQueue; // @synthesize resetMediaStateQueue=_resetMediaStateQueue;
