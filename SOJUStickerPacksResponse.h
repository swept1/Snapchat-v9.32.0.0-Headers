...
@class NSArray, NSString, SOJUStickerConfig, SOJUStickerSearchPack;
...
- (id)initWithStickerPacks:(id)arg1 searchPack:(id)arg2 stickerConfig:(id)arg3 stickerPacksV2:(id)arg4 searchPacksV2:(id)arg5;
