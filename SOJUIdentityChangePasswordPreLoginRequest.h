...
#import "SOJUIdentityChangePasswordPreLoginRequest.h"

@class NSString;

@interface SOJUIdentityChangePasswordPreLoginRequest : NSObject <SOJUIdentityChangePasswordPreLoginRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 sojuNewPassword:(id)arg4 preAuthToken:(id)arg5 usernameOrEmail:(id)arg6;
