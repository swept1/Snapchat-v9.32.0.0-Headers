...
@interface Friends : NSObject <SCTimeProfilable, NSCoding>
{
...
+ (id)createPredicateForSuggestedFriends:(long long)arg1;
+ (CDUnknownBlockType)createDescendingSortComparatorForSuggestedFriends:(long long)arg1;
+ (CDUnknownBlockType)_usernameComparator;
...
+ (id)suggestionPlacementToReasonMap;
