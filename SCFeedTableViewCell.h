...
@class NSString, NSTimer, SCAddFriendButtonV2, SCAnimatingReplaySnapView, SCFriendmojiView, SCLoadingIndicatorView, UIImageView, UILabel, UIScrollView, UIView;

@interface SCFeedTableViewCell : UITableViewCell <UIScrollViewDelegate, SCTimeProfilable, SCAddFriendButtonV2Delegate, UIGestureRecognizerDelegate>
{
    _Bool _highlightEnabled;
    _Bool _isAnimatingSubLabel;
    _Bool _shouldHideSubLabel;
    _Bool _shouldAnimateBackSublabelText;
    _Bool _isPulling;
    _Bool _isScrolling;
...
@property(nonatomic) _Bool shouldAnimateBackSublabelText; // @synthesize shouldAnimateBackSublabelText=_shouldAnimateBackSublabelText;
...
- (void)updateAddFriendButton:(id)arg1;
- (void)updateFriendMojiView;
- (void)updateFriendMojiViewWithFriend:(id)arg1;
- (void)updateMainLabelPositionForFriendMoji;
- (void)updateSubLabelFrame;
...
- (void)showSubstituteSubLabelBriefly:(CDUnknownBlockType)arg1;
- (void)showSubstituteSubLabelBrieflyIfNecessary;
- (void)prepareForReuse;
- (void)initCellBottomBorder;
