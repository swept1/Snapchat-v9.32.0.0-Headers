...
- (id)initWithLogged:(id)arg1 message:(id)arg2 isTwoFaEnabled:(id)arg3 allowedToUseCash:(id)arg4 verificationNeeded:(id)arg5 twoFaVerifiedDevices:(id)arg6 deepLinkResponse:(id)arg7;
