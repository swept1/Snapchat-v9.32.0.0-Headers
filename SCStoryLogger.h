...
@class NSMutableSet, SCStoriesViewingSession;

@interface SCStoryLogger : NSObject
{
    SCStoriesViewingSession *_currentStoriesViewingSession;
...
@property(nonatomic) __weak SCStoriesViewingSession *currentStoriesViewingSession; // @synthesize currentStoriesViewingSession=_currentStoriesViewingSession;
- (void).cxx_destruct;
...
- (void)logViewStoryStart:(id)arg1 initialView:(_Bool)arg2 initialStory:(_Bool)arg3;
