...
#import "SCBadgeCountObserverDelegate.h"
#import "SCChatAndFeedViewControllerDelegate.h"
#import "SCFeedTableViewCellDelegate.h"
#import "SCStartChatDelegate.h"
#import "SCTabBarViewDataSource.h"
#import "SCTabBarViewDelegate.h"
#import "SCTimeProfilable.h"
#import "SCViewingMediaDelegate.h"
#import "SendSnapNavigationControllerDelegate.h"
#import "StatusBarDelegate.h"
#import "SwipeViewParentDelegate.h"
#import "UIScrollViewDelegate.h"

@class AVCameraViewController<SwipeView>, CADisplayLink, NSArray, NSMutableSet, NSString, SCAppNotification, SCBadgeCountObserver, SCBandwidthLabelController, SCChatViewControllerV2, SCDiscoverViewController<SwipeView>, SCFeedToChatAnimationBlockingView, SCFeedViewController<SwipeView>, SCMainScrollView, SCMediaView, SCStatusBarController, SCStoriesViewController<SwipeView><SCDeepLinkableView>, SCTabBarItem, SCTabBarView, SCUserSession, UIViewController<SwipeView>;

@interface MainViewController : UIViewController <NavigationDelegate, SCFeedTableViewCellDelegate, StatusBarDelegate, SCStartChatDelegate, SCTimeProfilable, SCTabBarViewDelegate, SCBadgeCountObserverDelegate, SCTabBarViewDataSource, UIScrollViewDelegate, AVCameraViewControllerDelegate, SCChatAndFeedViewControllerDelegate, SendSnapNavigationControllerDelegate, ReplyDelegate, SwipeViewParentDelegate, SCViewingMediaDelegate>
{
    NSString *_token;
    SCUserSession *_userSession;
    SCChatViewControllerV2 *_farLeftVC;
    _Bool _appeared;
    SCAppNotification *_pendingNotificationToProcess;
    SCFeedToChatAnimationBlockingView *_feedToChatAnimationBlockingView;
    SCBandwidthLabelController *_bandwidthLabelControllor;
    SCTabBarItem *_feedTabItem;
    SCTabBarItem *_cameraTabItem;
    SCTabBarItem *_storyTabItem;
    ...
    SCBadgeCountObserver *_hovaBadgeCountObserver;
}

+ (long long)context;
+ (id)profiledSelectorNames;
@property(retain, nonatomic) SCBadgeCountObserver *hovaBadgeCountObserver; // @synthesize hovaBadgeCountObserver=_hovaBadgeCountObserver;
...
@property(retain, nonatomic) SCTabBarView *tabBarView; // @synthesize tabBarView=_tabBarView;
...
- (void).cxx_destruct;
- (void)addBandwidthLabelIfNeeded;
...
- (void)showBadgeButtons;
- (void)hideBadgeButtons;
- (void)transitionButtons:(_Bool)arg1 duration:(double)arg2;
...
- (void)presentFarRightVCAnimated:(_Bool)arg1 deepLinkURL:(id)arg2 additionalInfo:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)centerMiddleViewControllerWithOffsetX:(double)arg1;
...
- (void)animateToFrame:(struct CGRect)arg1 completion:(CDUnknownBlockType)arg2;
- (void)prepareToAnimateToFrame:(struct CGRect)arg1;
...
- (double)tabBarView:(id)arg1 visibilityForItemType:(long long)arg2;
- (struct _NSRange)visibleRangeForTabBarView:(id)arg1;
- (void)tabBar:(id)arg1 didTapItemWithType:(long long)arg2;
- (void)tabBar:(id)arg1 didLongPressItemWithType:(long long)arg2;
...
- (void)updateTabBarWithBounds:(struct CGRect)arg1 layout:(_Bool)arg2;
