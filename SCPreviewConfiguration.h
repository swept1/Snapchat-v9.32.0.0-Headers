...
@class NSArray, NSMutableDictionary, NSString, SCCaptionState, SCDiscoverMediaBlob, SCDrawingMetadata, SCPreviewLensesConfiguration, SCPreviewSnapchatGalleryConfiguration, SCUserSession, SnapTrophyMetrics, UIImage;
...
@interface SCPreviewConfiguration : NSObject
{
    ...
    SCPreviewLensesConfiguration *_lensesConfiguration;
...
@property(retain, nonatomic) SCPreviewLensesConfiguration *lensesConfiguration; // @synthesize lensesConfiguration=_lensesConfiguration;
