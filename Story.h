...
@interface Story : EphemeralMedia <MediaDataSource, MediaDelegate, MediaUploadDelegate, MediaImageProcessingDelegate, SCStoriesViewDataModel, SCStoryChromeViewDataModel, SCStoryExporterItem>
{
    ...
    NSString *_attributionDisplayName;
...
@property(copy, nonatomic) NSString *attributionUserId; // @synthesize attributionUserId=_attributionUserId;
@property(copy, nonatomic) NSString *attributionDisplayName; // @synthesize attributionDisplayName=_attributionDisplayName;
...
@property(copy, nonatomic) NSString *adHeadline; // @synthesize adHeadline=_adHeadline;
...
- (id)snapTimeColor;
- (id)snapDisplayTitleColor;
- (id)snapPosterDisplayName;
- (id)snapAdHeadline;
- (id)snapPostTime;
- (id)snapDisplayTitle;
