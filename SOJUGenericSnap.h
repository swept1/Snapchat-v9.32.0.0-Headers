...
- (id)initWithIdValue:(id)arg1 st:(id)arg2 m:(id)arg3 ts:(id)arg4 sts:(id)arg5 zipped:(id)arg6 pts:(id)arg7 orientation:(id)arg8 sn:(id)arg9 t:(id)arg10 timer:(id)arg11 capText:(id)arg12 capPos:(id)arg13 capOri:(id)arg14 broadcast:(id)arg15 broadcastMediaUrl:(id)arg16 broadcastUrl:(id)arg17 broadcastActionText:(id)arg18 broadcastSecondaryText:(id)arg19 broadcastHideTimer:(id)arg20 filterId:(id)arg21 rp:(id)arg22 cId:(id)arg23 replayed:(id)arg24 pending:(id)arg25 c:(id)arg26 esId:(id)arg27 egData:(id)arg28;
