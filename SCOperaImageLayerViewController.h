...
@class NSString, SCOperaConfiguration, SCOperaImageLayer, SCOperaImageLayerView;

@interface SCOperaImageLayerViewController : UIViewController <SCOperaLayerViewController, SCOperaDockableViewController>
{
    ...
    SCOperaImageLayer *_layer;
}

+ (id)layerViewControllerWithLayer:(id)arg1 configuration:(id)arg2 eventAnnouncer:(id)arg3;
@property(retain, nonatomic) SCOperaImageLayer *layer; // @synthesize layer=_layer;
