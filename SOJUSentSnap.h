...
- (id)initWithIdValue:(id)arg1 st:(id)arg2 m:(id)arg3 ts:(id)arg4 sts:(id)arg5 zipped:(id)arg6 pts:(id)arg7 orientation:(id)arg8 rp:(id)arg9 cId:(id)arg10 replayed:(id)arg11 pending:(id)arg12 c:(id)arg13;
