...
@class CountryCodePickerView, NSString, NSTimer, SCLoadingScreen, SCPhoneNumberPlaceholderTextField, SCVerificationCodeTextField, TTTAttributedLabel, UIButton, UILabel, UIScrollView, UISwitch, UITextField, UIView;

@interface MobileSettingsViewController : GenericSettingsViewController <CountryCodePickerViewDelegate, UITextFieldDelegate, MFMessageComposeViewControllerDelegate, SCVerificationCodeTextFieldDelegate, UIScrollViewDelegate, TTTAttributedLabelDelegate>
{
    ...
    _Bool _userSearchableByPhoneNumber;
...
@property(nonatomic) _Bool userSearchableByPhoneNumber; // @synthesize userSearchableByPhoneNumber=_userSearchableByPhoneNumber;
...
- (void).cxx_destruct;
- (void)_presentPasswordSettings;
- (void)_resetPasswordVerifyNumberDidSucceed;
...
- (void)_setMobile:(_Bool)arg1 phoneCall:(_Bool)arg2;
...
- (void)loadView;
- (id)getPageViewName;
- (id)initForType:(long long)arg1 preAuthToken:(id)arg2 usernameOrEmail:(id)arg3;
