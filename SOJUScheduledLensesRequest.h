...
#import "SOJUScheduledLensesRequest.h"

@class NSString;

@interface SOJUScheduledLensesRequest : NSObject <SOJUScheduledLensesRequest>
{
    NSString *_timestamp;
    NSString *_reqToken;
    NSString *_username;
...
- (id)initWithTimestamp:(id)arg1 reqToken:(id)arg2 username:(id)arg3 timeZone:(id)arg4;
