...
@class NSString, SCOperaConfiguration, SCOperaEventListenerAnnouncer, SCOperaGestureToolTipsLayer, SCOperaGestureToolTipsLayerView;

@interface SCOperaGestureToolTipsLayerViewController : UIViewController <SCOperaLayerViewController, SCOperaBlockingViewController>
{
...
@property(retain, nonatomic) SCOperaGestureToolTipsLayer *layer; // @synthesize layer=_layer;
