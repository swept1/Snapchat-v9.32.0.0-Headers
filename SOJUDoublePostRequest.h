...
- (id)initWithCaptionTextDisplay:(id)arg1 storyTimestamp:(id)arg2 myStory:(id)arg3 sharedIds:(id)arg4 verifiedUserIds:(id)arg5 lat:(id)arg6 longValue:(id)arg7 thumbnailData:(id)arg8 rawThumbnailData:(id)arg9 clientId:(id)arg10 type:(id)arg11 data:(id)arg12 uploadUrl:(id)arg13 key:(id)arg14 iv:(id)arg15 framing:(id)arg16 mediaId:(id)arg17 orientation:(id)arg18 zipped:(id)arg19 encGeoData:(id)arg20 filterId:(id)arg21 lensId:(id)arg22 cameraFrontFacing:(id)arg23 time:(id)arg24 timestamp:(id)arg25 reqToken:(id)arg26 username:(id)arg27 recipients:(id)arg28 recipientIds:(id)arg29 invitedRecipients:(id)arg30;
