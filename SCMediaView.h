...
@class AVPlayer, NSArray, NSMutableDictionary, NSString, SCCustomVolumeController, SCHeadset, SCSnapTimer, SCSponsoredSlugView, SCStoriesTimer, UIImageView;

@interface SCMediaView : SCFrameableContainerView <UIGestureRecognizerDelegate, SCPullToDismissVolumeController>
{
    struct CGSize _contentSize;
    _Bool _freeAVPlayerItem;
    _Bool _isLooping;
...
- (id)initWithFrame:(struct CGRect)arg1 useLocalPlayers:(_Bool)arg2 freeAVPlayerItem:(_Bool)arg3;
