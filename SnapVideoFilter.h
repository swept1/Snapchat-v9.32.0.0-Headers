...
@class AVAssetReader, AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, NSArray, NSData, NSObject<OS_dispatch_queue>, NSString, SCImageProcessVideoExportSession, SCMotionFilterAudioManager, UIImage;
...
- (void)_videoProcessingDidFailWithError:(id)arg1 commandsInfo:(id)arg2;
